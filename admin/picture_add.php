...
<form action="action/picture_add_do.php" method="post"  enctype="multipart/form-data">


<div style="text-align:center; margin-left:400px;">
  <div style=" width:500px;  height:35px;">
  <div style=" width:500px;  height:30px; font-size:26px; color:#C33;">添加图片信息  </div></div>
