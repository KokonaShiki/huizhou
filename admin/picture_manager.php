...
<div  style="height:30px; text-align: center; font-size:26px; color:#F00; margin-top:10px; margin-left:400px;"> 图片信息管理</div>
<form action="" method="post">
<div  style="text-align:center;width:1024px; margin-left:350px;">
<table border="1">
<tr>
  <td>编号</td><td>所属类别</td><td>图片名称</td><td>图片</td><td>状态</td>
  <td>　　发布时间</td><td colspan="4">　　　　操作</td>
</tr>
 <?   
  require_once("../conn/Conn_DB.php");  //包含数据库链接文件  
  $str = "select p.*,pt.PT_ID,pt.PT_Name from  Picture_Info p,Product_Type pt where p.PT_ID = pt.PT_ID order by P_CreateTime desc"; //查询语句
...
?>
  <tr>
    ...
    <td> <a href="action/picture_action_do.php?Type=1&P_ID=<? echo $result["P_ID"];?>">发布</a></td>
    <td> <a href="action/picture_action_do.php?Type=2&P_ID=<? echo $result["P_ID"];?>">放入回收站</a></td>
    <td> <a href="picture_update.php?P_ID=<? echo $result["P_ID"];?>">编辑</a></td>
